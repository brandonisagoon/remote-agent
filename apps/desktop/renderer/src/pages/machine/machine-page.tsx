...
/** The stdio bridge an ACP app runs to reach the server: the deployed copy
  ...
  return (
    ...
    >
      ...
      <SettingsSection
        value="server"
        title="Server"
        description="Where the server listens for HTTP. Changing these requires a server restart."
      >
        <SettingsCard>
      ...
      <SettingsSection
        value="acp"
        title="ACP"
        description="ACP apps — Zed, bb, T3 Code — attach to this machine's running sessions through the ACP socket. Configure the app to run the bridge command below as its agent server: it speaks ACP over stdio and forwards everything to the server, which must be running."
      >
        <SettingsCard>
